...
public class DaZhuanPanService
  implements KeyServiceI
{
  public String excute(String content, TextMessageResp defaultMessage, HttpServletRequest request)
  {
    ...
    article.setPicUrl(bundler.getString("domain") + "/plug-in/weixin/images/activity-lottery-1.png");

    article.setUrl(bundler.getString("domain") + "/zpController.do?goZhuanpan&accountid=" + accountid + "&openId=" + defaultMessage.getToUserName());
