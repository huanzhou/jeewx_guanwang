...
public class WeixinCmsSiteController extends BaseController
{
  ...
  public AjaxJson doDel(WeixinCmsSiteEntity weixinCmsSite, HttpServletRequest request)
  {
    ...
    weixinCmsSite = (WeixinCmsSiteEntity)this.systemService.getEntity(WeixinCmsSiteEntity.class, weixinCmsSite.getId());
  ...
  public AjaxJson doBatchDel(String ids, HttpServletRequest request)
  {
    ...
    try {
      for (String id : ids.split(",")) {
        WeixinCmsSiteEntity weixinCmsSite = (WeixinCmsSiteEntity)this.systemService.getEntity(WeixinCmsSiteEntity.class, id);
  ...
  {
    AjaxJson j = new AjaxJson();
    List lst = this.weixinCmsSiteService.findByProperty(WeixinCmsSiteEntity.class, "accountid", ResourceUtil.getShangJiaAccountId());
  ...
  public AjaxJson doUpdate(WeixinCmsSiteEntity weixinCmsSite, HttpServletRequest request)
  {
    ...
    WeixinCmsSiteEntity t = (WeixinCmsSiteEntity)this.weixinCmsSiteService.get(WeixinCmsSiteEntity.class, weixinCmsSite.getId());
    try
    {
  ...
  public ModelAndView goAdd(WeixinCmsSiteEntity weixinCmsSite, HttpServletRequest req)
  {
    if (StringUtil.isNotEmpty(weixinCmsSite.getId())) {
      weixinCmsSite = (WeixinCmsSiteEntity)this.weixinCmsSiteService.getEntity(WeixinCmsSiteEntity.class, weixinCmsSite.getId());
  ...
  public void exportXls(WeixinCmsSiteEntity weixinCmsSite, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid)
  {
    ...
    try {
      ...
      List weixinCmsSites = this.weixinCmsSiteService.getListByCriteriaQuery(cq, Boolean.valueOf(false));

      workbook = ExcelExportUtil.exportExcel(new ExcelTitle("微站点信息列表", "导出人:" + ResourceUtil.getSessionUserName().getRealName(), "导出信息"), WeixinCmsSiteEntity.class, weixinCmsSites);
  ...
  public void exportXlsByT(WeixinCmsSiteEntity weixinCmsSite, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid)
  {
    ...
    try {
      ...
      HSSFWorkbook workbook = null;
      workbook = ExcelExportUtil.exportExcel(new ExcelTitle("微站点信息列表", "导出人:" + ResourceUtil.getSessionUserName().getRealName(), "导出信息"), WeixinCmsSiteEntity.class, null);
  ...
  public AjaxJson importExcel(HttpServletRequest request, HttpServletResponse response) {
    ...
    for (Map.Entry entity : fileMap.entrySet()) {
      ...
      try {
        List<WeixinCmsSiteEntity> listWeixinCmsSiteEntitys = (List<WeixinCmsSiteEntity>)ExcelImportUtil.importExcelByIs(file.getInputStream(), WeixinCmsSiteEntity.class, params);
