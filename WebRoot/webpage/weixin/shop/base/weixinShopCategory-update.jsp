...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${weixinShopCategoryPage.name}", imageHref = "${weixinShopCategoryPage.imgurl}";
      if(name != ""){
 ...
 <div class="media_preview_area">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinShopCategoryPage.name}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">分类名称</label>
						</td>
					</tr>
					<c:if test="${ weixinShopCategoryPage.weixinShopCategoryEntity!=null}">
					<tr>
						<td align="right">
							<label class="Validform_label">
								上级分类
						...
						<td class="value">
						     	<input id="parentname" name="parentname" readonly="readonly" type="text" value="${weixinShopCategoryPage.weixinShopCategoryEntity.name}" style="width: 150px" class="inputxt" >
								<input id="parentid" type="hidden" name="weixinShopCategoryEntity.id" value="${weixinShopCategoryPage.weixinShopCategoryEntity.id }" />
								<span class="Validform_checktip"></span>
					...
					<td class="value">
							<span class="btn btn-success fileinput-button">
					     	...
					     	<input id="imgurl" name="imgurl" type="hidden" value="${weixinShopCategoryPage.imgurl}" style="width: 150px" class="inputxt">
  ...
  <script src = "webpage/weixin/shop/base/weixinShopCategory.js"></script>		