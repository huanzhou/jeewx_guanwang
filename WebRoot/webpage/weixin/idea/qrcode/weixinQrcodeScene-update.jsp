...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinQrcodeSceneController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="scenekey" name="scenekey" type="text" readonly="readonly" style="width: 150px" class="inputxt"  
									               
									                 value='${weixinQrcodeScenePage.scenekey}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="scenevalue" name="scenevalue" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinQrcodeScenePage.scenevalue}'>
							<span class="Validform_checktip"></span>
