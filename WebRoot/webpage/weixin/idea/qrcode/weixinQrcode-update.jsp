...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinQrcodeController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="actionInfo" name="actionInfo" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinQrcodePage.actionInfo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							...
							<c:forEach items="${scenelist}" var="scene">
          						<option value="${scene.scenekey}" selected="selected" <c:if test="${scene.id==sceneId}"> selected="selected" </c:if> >${scene.scenevalue}</option>
          					</c:forEach>
          				</select>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="expireSeconds" name="expireSeconds" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinQrcodePage.expireSeconds}'>
							<span class="Validform_checktip"></span>
