...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wxHuodongController.do?doAdd" tiptype="1">
...
<%--								               --%>
<%--								               >--%>
								<t:dictSelect field="hdStatus"  typeGroupCode="hdType"   hasLabel="false" type="select" defaultVal="1"></t:dictSelect>
							<span class="Validform_checktip"></span>
