...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wxZhongjiangController.do?doAdd" tiptype="1">
...
<%--								               --%>
<%--								               >--%>
							<t:dictSelect field="platformCode"  typeGroupCode="pf_code"   hasLabel="false" type="select" defaultVal="1"></t:dictSelect>
				...
				<tr>
					...
					<td class="value">
<%--					     	 <input id="huoddongId" name="huoddongId" type="text" style="width: 150px" class="inputxt"  --%>
<%--								               --%>
<%--								               >--%>
							<select id="huoddongId" name="huoddongId">
								<c:forEach items="${huodongEntities}" var="huodong">
								<option value="${huodong.id}">${huodong.hdName}</option>
								</c:forEach>
							</select>
							<span class="Validform_checktip"></span>
...
<%--								               --%>
<%--								               >--%>
							<t:dictSelect field="jpLevel"  typeGroupCode="jp_level"   hasLabel="false" type="select" defaultVal="1"></t:dictSelect>
							<span class="Validform_checktip"></span>
