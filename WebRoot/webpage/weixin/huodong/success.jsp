...
<body>
	<header>
		<div class="logo">
			<a class="history_back" href="javascript:history.go(-1);"><img height="40" src="http://cdn1.yaochufa.com/images/mobile/back.png" alt="返回"></a>
		</div>
		<span class="main_title">提示信息</span>
		...
		<div class="content">
            <div class="login_body">
                <ul class="login_inputs">
                   <li ><span class="label"><h1>兑奖信息录入成功！</h1></span></li>
