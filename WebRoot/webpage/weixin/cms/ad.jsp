		 		...
		 		<div class="inner">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<t:dictSelect field="showFlag" typeGroupCode="yesorno" hasLabel="false" defaultVal="${adPage.showFlag}" ></t:dictSelect>
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="orders" name="orders" style="width: 100px" value="${adPage.orders}" datatype="num">
								<span class="Validform_checktip"></span>
