        ...
        <t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override uploadFile" layout="table" action="weixinCmsStyleController.do?doAdd" tiptype="1" >
		  ...
		  <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		    <tr>
			  ...
			  <td class="value">
		        <input id="templateName" name="templateName" type="text" value="${weixinCmsStylePage.templateName}" style="width:300px" datatype="s2-10" class="inputxt" validType="weixin_cms_style,template_Name">
			...
			<tr>
			  ...
			  <td class="value">
			    ...
			    <input id="reviewImgUrl" name="reviewImgUrl" value="${weixinCmsStylePage.reviewImgUrl}" type="hidden" style="width: 150px" class="inputxt">
			...
			<tr>
			  ...
			  <td class="value">
		        <input id="templateUrl" name="templateUrl" value="${weixinCmsStylePage.templateUrl}" validType="weixin_cms_style,template_url" datatype="s2-10" type="text" value="${weixinCmsStylePage.templateUrl}"  style="width: 300px" class="inputxt" >
		     	<br>参考风格：car/baoma/
				<span class="Validform_checktip"></span>
