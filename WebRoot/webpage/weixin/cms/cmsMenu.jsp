		 		...
		 		<div class="inner">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<t:dictSelect field="showFlag" typeGroupCode="yesorno" hasLabel="false" defaultVal="${columnPage.showFlag}" ></t:dictSelect>
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="orders" name="orders" style="width: 100px" value="${columnPage.orders}" datatype="num">
								<span class="Validform_checktip"></span>
								<label class="Validform_label" style="display: none;">显示顺序</label>
							</td>
						</tr>
						<tr>
							<td align="right">
