...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="gzfrom" dialog="true" usePlugin="password" layout="table" action="unknownResponseController.do?su">
   <input id="id" name="id" type="hidden" value="${id}">
   <input id="accountId" name="accountId" type="hidden"  value="${unknownResponse.accountId}">
   <input id="templateName" name="templateName"  type="hidden" value="${unknownResponse.templateName}"/>
