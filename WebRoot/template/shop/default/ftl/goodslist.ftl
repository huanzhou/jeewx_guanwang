...
<head>
    ...
    <title>${weixinShopContent.category.name?if_exists}</title>
    ...
    <div id="top">
        ...
        <div class="m-detail-mainout">
            <div class="m-hd">
                ...
                <div class="tit">${weixinShopContent.category.name?if_exists}</div>
                <div>
    				 <a href="weixinVipController.do?goPage&page=index&shopSymbol=shop&accountid=${weixinShopContent.accountid}" class="uc">用户中心</a>
 				</div>
				<div>
            ...
            <form id="search_form" name="search_form" action="" method="post">
                <div class="m-l-search"><input type="hidden" name="wecha_id" value="oLA6VjvtaKhnWKq1G0S8gxil7nbU">
                    ...
                    <input id="keyword" class="inp-search"  name="keyword" type="search" value="${weixinShopContent.keyword?default("")}" placeholder="输入关键字搜索">
                    <input class="btn-search" name="search-btn" onclick="javascript:search();" type="button" >
                </div>
            ...
            <ul id="m_list" class="m-list ">
             <#list weixinShopContent.goodsList as goods>
                <li>
                    <span class="pic">
                        <a href="weixinShopController.do?goPage&page=goodsdetail&goodsid=${goods.id}&accountid=${weixinShopContent.accountid?default("")}">
            ...
            <script type="text/javascript">
	            function search(){
	            	 var key=$("#keyword").val();
	            	 var base_url = 'weixinShopController.do?goPage&page=goodslist&accountid=${weixinShopContent.accountid?default("")}';
	            	 location.href=base_url+"&keyword="+key;
	            }
    $(function() {

        //点击排序
        var base_url = 'weixinShopController.do?goPage&page=goodslist&accountid=${weixinShopContent.accountid?default("")}&categoryid=${weixinShopContent.params.categoryid?if_exists}';
        var b_url = 'weixinShopController.do?goPage&page=goodslist&accountid=${weixinShopContent.accountid?default("")}&categoryid=${weixinShopContent.params.categoryid?if_exists}'
        method = 'DESC',
        ...
        /*---------------------加载更多--------------------*/
         var pbase_url = 'weixinShopController.do?goodslist&categoryid=${weixinShopContent.params.categoryid?if_exists}';
        var pb_url = 'weixinShopController.do?goodslist&categoryid=${weixinShopContent.params.categoryid?if_exists}'
            ...
            $(window).bind("scroll",function() {
                if ($(document).scrollTop() + $(window).height() >= $(document).height()) {
                    ...
                    $.ajax({
                        ...
                        url :  pb_url + '&sort=' + order + '&order=' + _get_method + '&pagesize='+pagesize,
                        dataType : "json",
